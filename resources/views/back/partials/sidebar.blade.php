<div class="main-menu menu-fixed menu-accordion menu-shadow {{ user_option('theme_color') == 'dark' ? 'menu-dark' : 'menu-light' }}" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @can('workSamples')
                <li class="nav-item has-sub {{ open_class(['admin.work-samples.*']) }}"><a href="#"><i class="feather feather-briefcase"></i><span class="menu-title" > مدیریت نمونه کارها</span></a>
                    <ul class="menu-content">
                        @can('workSamples.index')
                            <li class="{{ active_class('admin.work-samples.index') }}">
                                <a href="{{ route('admin.work-samples.index') }}"><i class="feather icon-circle"></i><span class="menu-item">لیست نمونه کارها</span></a>
                            </li>
                        @endcan

                        @can('workSamples.create')
                            <li class="{{ active_class('admin.work-samples.create') }}">
                                <a href="{{ route('admin.work-samples.create') }}"><i class="feather icon-circle"></i><span class="menu-item">ایجاد نمونه کارها</span></a>
                            </li>
                        @endcan

                        @can('workSamples.category')
                            <li class="{{ active_class('admin.work-samples.categories.index') }}">
                                <a href="{{ route('admin.work-samples.categories.index') }}"><i class="feather icon-circle"></i><span class="menu-item">دسته بندی ها</span></a>
                            </li>
                        @endcan
                            @can('workSamples.technology')
                            <li class="{{ open_class(['admin.technology.*']) }}">
                                <a href="#"><i class="feather icon-circle"></i><span class="menu-item"> فناوری ها</span></a>
                                <ul class="menu-content">
                                    <li class="{{ active_class('admin.work-samples.technology.index') }}">
                                        <a class="{{ active_class('admin.work-samples.technology.index') }}" href="{{ route('admin.work-samples.technology.index') }}"><i class="feather icon-circle"></i><span class="menu-item">لیست فناوری ها</span></a>
                                    </li>
                                    <li class="{{ active_class('admin.work-samples.technology.create') }}">
                                        <a class="{{ active_class('admin.work-samples.technology.create') }}" href="{{ route('admin.work-samples.technology.create') }}"><i class="feather icon-circle"></i><span class="menu-item">ایجاد فناوری جدید</span></a>
                                    </li>
                                </ul>
                            </li>
                            @endcan
                            @can('workSamples.features')
                            <li class="{{ open_class(['admin.features.*']) }}">
                                <a href="#"><i class="feather icon-circle"></i><span class="menu-item"> ویژگی ها</span></a>
                                <ul class="menu-content">
                                    <li class="{{ active_class('admin.features.index') }}">
                                        <a class="{{ active_class('admin.features.index') }}" href="{{ route('admin.features.index') }}"><i class="feather icon-circle"></i><span class="menu-item">لیست ویژگی ها</span></a>
                                    </li>
                                    <li class="{{ active_class('admin.features.create') }}">
                                        <a class="{{ active_class('admin.features.create') }}" href="{{ route('admin.features.create') }}"><i class="feather icon-circle"></i><span class="menu-item">ایجاد ویژگی جدید</span></a>
                                    </li>
                                </ul>
                            </li>
                            @endcan
            ...
            @can('products')
                <li class="nav-item has-sub {{ open_class(['admin.products.*']) }}"><a href="#"><i class="feather icon-shopping-cart"></i><span class="menu-title" > محصولات</span></a>
                    <ul class="menu-content">
                        @can('products.index')
            ...
            @can('admins')
                <li class="nav-item has-sub {{ open_class(['admin.admins.*']) }}"><a href="#"><i class="feather icon-users"></i><span class="menu-title" > مدیران</span></a>
                    <ul class="menu-content">
                        @can('admins.index')
                            <li class="{{ active_class('admin.admins.index') }}">
                                <a href="{{ route('admin.admins.index') }}"><i class="feather icon-circle"></i><span class="menu-item">لیست مدیران</span></a>
                            </li>
                        @endcan

                        @can('admins.create')
                            <li class="{{ active_class('admin.admins.create') }}">
                                <a href="{{ route('admin.admins.create') }}"><i class="feather icon-circle"></i><span class="menu-item">ایجاد مدیر</span></a>
                            </li>
                        @endcan
            ...
            <li class="nav-item has-sub">
                ...
                <ul class="menu-content">
                    ...
                    @endcan
                        @can('settings.others')
                            <li class="nav-item has-sub {{ open_class(['admin.special-comments.*']) }}"><a href="#"><i class="feather icon-message-circle"></i><span class="menu-title" > نظرات ویژه</span></a>
                                <ul class="menu-content">
                                    <li class="{{ active_class('admin.special-comments.index') }}">
                                        <a href="{{ route('admin.special-comments.index') }}"><i class="feather icon-circle"></i><span class="menu-item">لیست نظرات</span></a>
                                    </li>


                                    <li class="{{ active_class('admin.special-comments.create') }}">
                                        <a href="{{ route('admin.special-comments.create') }}"><i class="feather icon-circle"></i><span class="menu-item">ایجاد نظر</span></a>
                                    </li>
                    ...
                    <li class="{{ active_class('admin.notifications') }} nav-item">
                        <a href="{{ route('admin.notifications') }}" class="d-block">
