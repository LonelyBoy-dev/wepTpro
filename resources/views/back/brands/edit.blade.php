                                            ...
                                            <div class="col-12 col-md-6" style="margin: 0 auto">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" id="image_label"
                                                           ...
                                                           aria-label="Image" aria-describedby="button-image" value="{{@$brand->image}}">

                                                    <span class="remove-img-uploader @if(!$brand->image)display-hidden @endif">
                                                            <i class="fa fa-trash text-danger px-1"></i>
                                                    </span>

                                                    <div class="file-uploader dropzone dropzone-area mb-2 ui-sortable dz-clickable"
                                                         id="button-image">
                                                        <div class="img-uploader @if(!$brand->image)display-hidden @endif">
