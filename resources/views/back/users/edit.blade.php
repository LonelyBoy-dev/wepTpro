                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <fieldset class="form-group">
                                                    ...
                                                    <span class="remove-img-uploader-profile @if($user->image=="")display-hidden @endif">
                                                    ...
                                                    <div class="file-uploader-profile dropzone dropzone-area mb-2 ui-sortable dz-clickable"
                                                         id="button-image">
                                                        <div class="img-uploader @if($user->image=="")display-hidden @endif">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control ltr" name="username" value="{{ $user->mobile }}">
                                                </div>
                                            </div>
                                       ...
                                       <div id="roles-div" class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label>گذرواژه</label>
                                                    <input type="password" id="password" class="form-control" name="password" readonly onfocus="this.removeAttribute('readonly');">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label>تکرار گذرواژه</label>
                                                    <input type="password" class="form-control ltr" name="password_confirmation" readonly onfocus="this.removeAttribute('readonly');">
                                                </div>
                                            </div>
