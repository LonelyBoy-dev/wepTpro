...
function get_widget_mySite($widget)
{
    $variables = [];
    ...
    switch ($widget->key) {
        ...
        case 'main-slider2': {
            $variables['main_sliders2'] = Slider::where('group', 'main_sliders')
                ->where('published', true)
                ->orderBy('ordering', $widget->option('ordering', 'asc'))
                ->take($widget->option('number', 5))
                ->get();
        ...
        case 'features': {
            $variables['features'] = \Modules\Features\Entities\Feature::where('published', true)
                ->orderBy('ordering')
                ->take($widget->option('number', 4))
                ->get();
        ...
        case 'about-us': {
            ...
            $variables['about-us'] = Widget::where('id', $widget->id)
                ->with('options')
        ...
        case 'work-samples': {
            $variables['work-samples'] = Modules\WorkSample\Entities\WorkSample::where('published', true)
                ->orderBy('id', $widget->option('ordering', 'asc'))
                ->take($widget->option('number', 6))
                ->get();
        ...
        case 'work-samples2': {
            $variables['work-samples2'] = Modules\WorkSample\Entities\WorkSample::where('published', true)
                ->orderBy('id', $widget->option('ordering', 'asc'))
                ->take($widget->option('number', 4))
                ->get();
        ...
        case 'SpecialComment': {
            $variables['SpecialComment'] = \Modules\SpecialComments\Entities\SpecialComment::orderBy('id', $widget->option('ordering', 'asc'))
                ->take($widget->option('number', 3))
                ->get();
        ...
        case 'SpecialComment2': {
            $variables['SpecialComment2'] = \Modules\SpecialComments\Entities\SpecialComment::orderBy('id', $widget->option('ordering', 'asc'))
                ->take($widget->option('number', 3))
                ->get();
        ...
        case 'WorkSampleTechnology': {
            $variables['WorkSampleTechnology'] = \Modules\WorkSample\Entities\WorkSampleTechnology::orderBy('id', $widget->option('ordering', 'asc'))
                ->take($widget->option('number', 3))
                ->get();
        ...
        case 'categories': {
            ...
            $variables['categories'] = Category::where('type', 'productcat')
                ->orderBy('ordering')
                ->whereIn('id', $ids)
                ->get();
...
function theme_first_config_mySite()
{
    widget_seeder_mySite();
}
