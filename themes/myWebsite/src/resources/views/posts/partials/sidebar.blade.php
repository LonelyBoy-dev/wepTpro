                    ...
                    <div class="item">
                        <div class="item-inner">
                            <div class="item-thumb">
                                <a href="{{ route('front.blogs.show', ['post' => $item]) }}" class="img-holder" style="background-image: url('{{ $item->image ?: theme_asset('images/blog-empty-image.jpg') }}')"></a>
                            </div>
                            <p class="title">
                                <a href="{{ route('front.blogs.show', ['post' => $item]) }}">{{ $item->title }}</a>
                            </p>
                            <div class="item-meta">
