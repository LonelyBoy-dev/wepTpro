        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    <div class="card border-0 sidebar sticky-bar rounded post-shadow">
                        <div class="card-body">
                            <!-- SEARCH -->
                            <div class="widget">
                            ...
                            <div class="widget mb-4 pb-2">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="clearfix post-recent">
                                        <div class="post-recent-thumb float-start"> <a href="{{ route('front.blog.show', ['blog' => $item]) }}"> <img alt="img" src="{{asset($item->image)}}" class="img-fluid rounded"></a></div>
                                        <div class="post-recent-content float-start"><a href="{{ route('front.blog.show', ['blog' => $item]) }}">{{ $item->title }} </a><span class="text-muted mt-2">{{ verta($item->created_at)->format('%d %B %Y') }}</span></div>
                                    </div>
                                    @endforeach
                                </div>
                            </div>
