                ...
                <div class="col-xl-4 col-lg-5 col-md-7 col-12 mx-auto">
                    <div class="form-ui dt-sl dt-sn pt-4">
                        ...
                        <div class="message-light">
                            ...
                            <a href="{{ route('password.request') }}" class="btn-link-border">
                                ویرایش شماره
                            </a>
                        </div>
                        <form id="one-time-login-form" action="{{ route('one-time-login') }}">
                            @csrf
                            ...
                            <div class="form-row mt-2">
                                <span class="text-primary">دریافت مجدد کد تایید</span> (<p data-action="{{ route('password.request') }}" id="countdown-verify-end"></p>)
                            </div>
