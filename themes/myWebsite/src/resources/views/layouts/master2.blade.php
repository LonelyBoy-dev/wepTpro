...
<head>
    ...
    @if (config('app.debug'))
        ...
        <!-- Main CSS File -->
        <link rel="stylesheet" href="{{ theme_asset('css/main.css') }}?v=11">
        <link rel="stylesheet" href="{{ theme_asset('css/styles.css') }}?v=11">
...
<body>
    ...
    @if (config('app.debug'))
        ...
        <script src="{{ theme_asset("js/scripts.js") }}?v=8"></script>
    @else
        <!-- All JS Files -->
