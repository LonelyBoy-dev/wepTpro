                    ...
                    <div class="col-lg-4 col-md-6 mt-4 pt-2">
                        <div class="card border-0 work-container work-modern position-relative d-block overflow-hidden rounded">
                            <div class="portfolio-box-img position-relative overflow-hidden text-center">
                                <img class="item-container img-fluid mx-auto" src="{{asset($item->image)}}" alt="{{$item->title}}" style="max-height: 292px"/>
                                <div class="overlay-work bg-dark"></div>
                                <div class="content">
                                    <h6 class="text-light tag mb-0"><a href="{{ route('front.work-samples.show', ['work_sample' => $item]) }}" class="text-white title">{{$item->title}}</a></h6>
                                </div>
                                <div class="client">
