...
class ProductController extends Controller
{
    ...
    {
        $categories = Category::whereNull('Category_id')->where('type', 'productcat')->orderBy('ordering')->get();
    ...
    public function categoryProducts(Category $category)
    {
        ...
        $ids       = $category->allProducts()->published()->pluck('id');
    ...
    {
        $products = Product::published()->where('title', 'like', '%' . $request->q . '%')->latest()->paginate(20);
