        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="profile-navbar">
                    <h4>سفارش شماره <span class="font-en">{{ $order->id }}</span><span>ثبت شده در تاریخ {{ verta($order->created_at)->format('%d %B %Y') }}</span></h4>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($order->transactions()->latest()->get() as $transaction)
                                                <tr>
                                                    ...
                                                    <td class=" date">
                                                        <p>{{ verta($transaction->created_at)->format('%d %B %Y H:i:s') }}</p>
                                                    </td>
                                                    <td class="price">
