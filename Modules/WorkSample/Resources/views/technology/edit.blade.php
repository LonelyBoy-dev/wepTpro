                ...
                <div id="main-card" class="card-content">
                    <div class="card-body">
                        <div class="col-12 col-md-10 offset-md-1">
                            <form class="form" id="brand-edit-form" method="post" action="{{ route('admin.work-samples.technology.update', ['technology' => $technology]) }}">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6" style="margin: 0 auto">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" id="image_label"
                                                       ...
                                                       aria-label="Image" aria-describedby="button-image" value="{{@$technology->image}}">

                                                <span class="remove-img-uploader @if(!$technology->image)display-hidden @endif">
                                                            <i class="fa fa-trash text-danger px-1"></i>
                                                    </span>

                                                <div class="file-uploader dropzone dropzone-area mb-2 ui-sortable dz-clickable"
                                                     id="button-image">
                                                    <div class="img-uploader @if(!$technology->image)display-hidden @endif">
...
@push('scripts') 
    ...
    <script src="{{ asset('back/assets/js/pages/workSamples/technology/edit.js') }}"></script>
    <script>
