                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">ایجاد نمونه کار
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="description" class="card">
                    <div class="card-header">
                        <h4 class="card-title">ایجاد نمونه کار جدید</h4>
                    </div>

                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="post-create-form" action="{{ route('admin.work-samples.store') }}" data-redirect="{{ route('admin.work-samples.index') }}" method="post">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="summary" class="form-control" rows="3" name="summary"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label>وب سایت</label>
                                                    <input type="text" class="form-control text-right" name="webSite" style="direction: ltr">
                                                </div>
                                            </div>
                                            <div class="col-md-12 ">
                                                <div class="form-group">
                                                    <label>فناوری های بکار رفته</label>
                                                    <select class="form-control product-categories" name="technologies[]" multiple>
                                                        @foreach ($technologies as $item)
                                                            <option
                                                                    class="lnon-leaf"
                                                                    data-pup="{{ $item->category_id }}" value="{{ $item->id }}">{{ $item->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ایجاد نمونه کار</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/workSamples/create.js') }}"></script>
    <script>
