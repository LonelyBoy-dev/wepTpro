                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb no-border">
                                    ...
                                    <li class="breadcrumb-item active">افزودن نظر
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div id="main-card" class="card-content">
                        <div class="card-body">
                            <div class="col-12 col-md-10 offset-md-1">
                                <form class="form" id="post-create-form" action="{{ route('admin.special-comments.store') }}" data-redirect="{{ route('admin.special-comments.index') }}" method="post">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-primary mr-1 mb-1 waves-effect waves-light">ایجاد نظر</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
...
@push('scripts')
    ...
    <script src="{{ asset('back/assets/js/pages/SpecialComments/create.js') }}?v=2"></script>
    <script>
