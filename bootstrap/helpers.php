...
function Admin() {
    return \Illuminate\Support\Facades\Auth::guard('adminPanel')->user();
}
 ...
 * @return void
 */
function sendSms($pattern_code, $mobile, $input_data, $type = null, $user_id = null)
{
...
{
    return env('ADMIN_ROUTE_PREFIX','admin');
}
